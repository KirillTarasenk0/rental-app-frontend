import './BookedProperties.scss';
import {useGetBookedPropertiesQuery} from "../../slices/propertiesBookApi";
import {Link} from "react-router-dom";
import {PropertyCard} from "../../components/propertyCard/PropertyCard";

export const BookedProperties = () => {
    const { data: properties, error, isLoading } = useGetBookedPropertiesQuery();
    return (
        <>
